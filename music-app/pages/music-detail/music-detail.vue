<template>
	...
	<view style="height: 100vh;" :class="nightStatus ? 'nightTheme' : ''">
		...
		<view class="flex align-center justify-center" style="height: 440rpx;">
			<image :src="audioCover" lazy-load style="border-radius: 35rpx;box-shadow: 0 2rpx 6rpx 0;height: 420rpx;"></image>
		</view>
		...
		<view>
			...
			<view class="flex align-center justify-center font text-light-black" style="padding-top: 50rpx;">
				<view class="flex flex-column align-center" @tap="changeStatus('listStatus')">
					<my-icon iconId="icon-liebiao" iconSize="60"></my-icon>
		...
		<!-- 播放列表部分 -->
		<view class="fixed-bottom shadow p-2" style="height: 300rpx;border-radius: 30rpx;" v-else>
