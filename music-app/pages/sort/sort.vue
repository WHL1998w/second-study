			...
			<scroll-view scroll-y :scroll-into-view="rightIndex" scroll-with-animation :style="{height:`${calHeight}rpx`}"
			 @scroll="rightToleft">
				<block v-for="(item, index) in rightListRes" :key="index">
					<view style="height: 250rpx; margin-bottom: 70rpx;" :id="`right${index}`" class="">
						<!-- 顶部标题 -->
						...
						<!-- 底部内容 -->
						<view class="flex flex-wrap bg-white rounded font" style="height: 150rpx;">
